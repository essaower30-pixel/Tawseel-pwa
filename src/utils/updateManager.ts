...
export const DEFAULT_INITIAL_UPDATE: AppUpdateInfo = {
  id: "update_v3_6_0",
  version: "v3.6.0",
  title: "تحديث كود تسليم واستلام الطلبية 🔑 ومزامنة التتبع الفوري",
  releaseDate: "سبتمبر 2026",
  features: [
    "ظهور كود تسليم واستلام الطلبية 🔑 مباشرة للزبون مع إمكانية نسخه بنقرة واحدة",
    "تحديث فوري وتلقائي لشاشات الهواتف ومسح الكاش القديم لتطبيق أحدث التعديلات",
    "إلغاء تنبيهات أمان السائق المرورية المكررة لتسهيل واجهة تتبع الطلبات",
    "اعتماد التوجيه الذكي: يذهب الطلب للإدارة أولاً للاعتماد ثم للمتجر والكابتن"
  ],
  notes: "تحديث أمان أساسي يضمن تسليم الطلب لصاحبه الفعلي عبر كود الأمان وتحديث البيانات لحظياً.",
